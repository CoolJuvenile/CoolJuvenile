...
<h3 align="center">嵌入式开发 · IoT 创客 · 内核折腾者</h3>

---

### 👋 Hello / 你好

> A developer passionate about low-level systems, embedded hardware, and IoT security.
> 热爱底层系统、嵌入式硬件和 IoT 安全的开发者。

I build things that bridge hardware and software — from ESP32 WiFi tools to Android kernel hacking.
专注于软硬件结合的项目 —— 从 ESP32 WiFi 工具到 Android 内核折腾。
...
<td>
  <img src="https://img.shields.io/badge/ESP32--S3-black?style=flat&logo=espressif&logoColor=white&labelColor=E7352C">
  ...
  <img src="https://img.shields.io/badge/SSD1306-OLED-blue?style=flat">
</td>
</tr>
<tr>
...
<td>
  ...
  <img src="https://img.shields.io/badge/Android-AOSP-3DDC84?style=flat&logo=android&logoColor=white">
